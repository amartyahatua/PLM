...
if __name__ == "__main__":
    ...
    parser.add_argument("--tokenizer", type=str, default="distilbert-base-uncased", help="Path to the test CSV file")
    parser.add_argument("--model", type=str, default="distilbert-base-uncased", help="Path to the test CSV file")
    parser.add_argument("--output_dir", type=str, default="../distilbert-base-uncased", help="output directory" )
