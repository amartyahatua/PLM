...
if __name__ == "__main__":
    ...
    parser.add_argument("--tokenizer", type=str, default="FacebookAI/roberta-base", help="Path to the test CSV file")
    parser.add_argument("--model", type=str, default="FacebookAI/roberta-base", help="Path to the test CSV file")
